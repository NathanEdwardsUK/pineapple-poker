...
public class HandEvaluator {
    ...
    public int[] fiveCardStrength(ArrayList<Card> cards) {
        ...
        For any hand I calculate an int array which describes the strength of their hand.
        For any 2 hands with respective int[] strength1 and strength 2.
        ...
        hand2 = 3h,3s,3c,10d,Js     strength2 = [4, 3, 11, 10]      Trips: 3, Kickers: J, 10
        ...
        // Royal Flush
        if (flush && straight && minValueAcesLow == 10) {
            return new int[] {10};
        }
        // Straight Flush
        else if (flush && straight) {
            return new int[] {9, maxValueAcesHigh};
        }
        // Quads
        else if (quads.size() == 1) {
            return new int[] {8, quads.getFirst(), kickers.getFirst()};
        }
        // Full House
        else if (trips.size() == 1 && pairs.size() == 1) {
            return new int[] {7, trips.getFirst(), pairs.getFirst()};
        }
        // Flush
        else if (flush) {
            return new int[] {6,
        ...
        // Straight
            ...
            return new int[] {5, minValueAcesHigh};
        }
        // Trips
